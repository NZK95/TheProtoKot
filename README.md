...
- **🧑‍💻Админ панель** - Удобная панель которая позволяет отслеживать активность пользователей (например количество пользователей за 5 минут или за 1 день), взаимодействовать с базами данных, контроллировать лимиты в чекере жалоб, банить или кикать подьзователя, делать рассылку.
> [!NOTE]
