...
## Возможности
- **📄 Документы** - Система автоматического создания документов и протоколов для различных фракций. Пользователю достаточно выбрать нужную фракцию, тип документа и ответить на несколько вопросов — бот самостоятельно сформирует готовый результат в нужном формате.
